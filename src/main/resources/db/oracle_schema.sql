...
CREATE SEQUENCE PRIDEPROT.CLUSTER_PSM_PSM_ID_SEQ START WITH 1 NOCACHE ORDER ;

CREATE SEQUENCE PRIDEPROT.FEATURE_FEATURE_ID_SEQ START WITH 1 NOCACHE ORDER ;
...
CREATE TABLE PRIDEPROT.RELEASE_SUM
  (
    ...
    RELEASE_DATE DATE CONSTRAINT NNC_RELEASE_SUM_RELEASE_DATE NOT NULL ,
