...
ALTER TABLE PRIDEPROT.PEP_CLUSTER ADD CONSTRAINT PEP_CLUSTER_CLUSTER_FK FOREIGN KEY ( CLUSTER_ID ) REFERENCES PRIDEPROT.PRIDE_CLUSTER ( CLUSTER_ID ) ;
