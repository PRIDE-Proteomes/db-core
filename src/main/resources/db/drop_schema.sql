...
CREATE TABLE PRIDEPROT.PEPTIDE 
    ( 
     ...
     CANONICAL NVARCHAR2 (10)  NOT NULL CHECK ( CANONICAL IN ('FALSE', 'TRUE')) , 
...
CREATE TABLE PRIDEPROT.STAR 
    ( 
     ...
     COUNT NUMBER , 
     TYPE NVARCHAR2 (45) DEFAULT 'NONE' 
    ) 
;
...
ALTER TABLE PRIDEPROT.STAR 
    ...
    CHECK ( TYPE IN ('BRONZE', 'GOLD', 'NONE', 'SILVER')) 
;
...
CREATE OR REPLACE TRIGGER PRIDEPROT.PEPTIDE_PEPTIDE_PK_TRG 
BEFORE INSERT ON PRIDEPROT.PEPTIDE 
FOR EACH ROW 
WHEN (NEW.PEPTIDE_PK IS NULL) 
BEGIN 
    SELECT PRIDEPROT.PEPTIDE_PEPTIDE_PK_SEQ.NEXTVAL INTO :NEW.PEPTIDE_PK FROM DUAL; 
END;
/
...
CREATE OR REPLACE TRIGGER PRIDEPROT.PROT_GROUP_PROT_GROUP_PK_TRG 
BEFORE INSERT ON PRIDEPROT.PROT_GROUP 
FOR EACH ROW 
WHEN (NEW.PROT_GROUP_PK IS NULL) 
BEGIN 
    SELECT PRIDEPROT.PROT_GROUP_PROT_GROUP_PK_SEQ.NEXTVAL INTO :NEW.PROT_GROUP_PK FROM DUAL; 
END;
/
...
CREATE OR REPLACE TRIGGER PRIDEPROT.Q_METHOD_QUALITY_METHOD_PK_TRG 
BEFORE INSERT ON PRIDEPROT.Q_METHOD 
FOR EACH ROW 
WHEN (NEW.QUALITY_METHOD_PK IS NULL) 
BEGIN 
    SELECT PRIDEPROT.Q_METHOD_QUALITY_METHOD_PK_SEQ.NEXTVAL INTO :NEW.QUALITY_METHOD_PK FROM DUAL; 
END;
/
...
CREATE OR REPLACE TRIGGER PRIDEPROT.SCORE_SCORE_PK_TRG 
BEFORE INSERT ON PRIDEPROT.SCORE 
FOR EACH ROW 
WHEN (NEW.SCORE_PK IS NULL) 
BEGIN 
    SELECT PRIDEPROT.SCORE_SCORE_PK_SEQ.NEXTVAL INTO :NEW.SCORE_PK FROM DUAL; 
END;
/
...
CREATE OR REPLACE TRIGGER PRIDEPROT.STAR_STAR_PK_TRG 
BEFORE INSERT ON PRIDEPROT.STAR 
FOR EACH ROW 
WHEN (NEW.STAR_PK IS NULL) 
BEGIN 
    SELECT PRIDEPROT.STAR_STAR_PK_SEQ.NEXTVAL INTO :NEW.STAR_PK FROM DUAL; 
END;
/
